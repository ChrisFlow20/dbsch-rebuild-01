...
@DoNotObfuscate
public enum BootstrapIcons implements Glyph {
  a123(''),
  alarm_fill(''),
  alarm(''),
  align_bottom(''),
  ...
  public static final String BOOTSTRAP_GLYPH_FONT = "bootstrapicons-glyph-font";
  
  public static final String PREFIX = "bi-";
  
  public static final int LOAD_FONT_SIZE = 32;
  
  BootstrapIcons(char paramChar) {
    this.character = paramChar;
  }
  
  public Label glyph(String... paramVarArgs) {
    Label label = new Label("" + this.character);
    label.getStyleClass().addAll((Object[])new String[] { "bootstrapicons-glyph-font", "glyph" });
  ...
  public static void prepareAsGlyph(Label paramLabel) {
    paramLabel.getStyleClass().addAll((Object[])new String[] { "bootstrapicons-glyph-font", "glyph" });
  }
  
  public String getId() {
    return "bi-" + String.valueOf(this);
  }
  
  public static Label resolve(String paramString) {
    try {
      BootstrapIcons bootstrapIcons = valueOf(paramString);
      return bootstrapIcons.glyph(new String[0]);
    } catch (IllegalArgumentException illegalArgumentException) {
      Log.f("Cannot find glyph: bi-" + paramString);
      return question.glyph(new String[0]);
    } 
  }
  
  public String getHtmlTag() {
    return "<i class=\"bi bi-" + toString().toLowerCase().replaceAll("_", "-") + "\"></i>";
  }
  
  static {
    try {
      FileInputStream fileInputStream = new FileInputStream(Sys.A.resolve("bootstrap-icons.ttf").toFile());
      try {
        Font.loadFont(fileInputStream, 32.0D);
      ...
      Log.a("Error loading Bootstrap Icons font ", throwable);
    } 
  }
}
